        ...
        <div className="ContCons">
          ...
          <div className="Tt1Cons">
            ...
            <div className="ButtTitleConsulta btn-group" role="group">
              <button
                type="button"
                onClick={() => qualSituacaoMostrarClick("Agendados")}
              ...
              <button
                type="button"
                onClick={() => qualSituacaoMostrarClick("Concluidos")}
                className="btn btn-secondary"
              >
                Concluídos
              </button>
              <button
                type="button"
                onClick={() => qualSituacaoMostrarClick("Cancelados")}
                className="btn btn-secondary"
              >
                Cancelados
              </button>
              <button
                type="button"
                onClick={() => qualSituacaoMostrarClick("Não Compareceu")}
                className="btn btn-secondary"
              >
                Não Compareceu
              </button>
          ...
          <div className="BodyCons">
                      ...
                      <div className="geralCons">
                        ...
                        <div className="lineForm4">
                          <button
                            ...
                            className="buttonnn btn btn-outline-primary"
                          >
                            Remarcar
                          </button>
                        </div>
                      ...
                      <div className="pagmCons">
                        ...
                        <div className="linePag3">
                          <div className="buttsPag">
                            <button
                              onClick={() =>
                                cancelarConsultaClick(x.idConsulta)
                              }
            ...
            {situacaoMostrar === "Cancelados" && cancelados !== undefined && (
              <div>
                {cancelados.map((x) => (
                  <div className="boxCons">
                    <div className="TtsCons">
                        ...
                        {x.nota === null && (
                          <div className="linePag3">
                            <div className="buttsPag">
                              <button
                                onClick={() =>
                                  avaliarConsultaClick(x.idConsulta)
                                }
            ...
            {situacaoMostrar === "Não Compareceu" &&
              naoCompareceu !== undefined && (
                <div>
                  {naoCompareceu.map((x) => (
                    <div className="boxCons">
                      <div className="TtsCons">
            ...
            {situacaoMostrar === "Não Compareceu" &&
              naoCompareceu.length === 0 && (
                <div className="semConsultasAgendadas">
                  <h3>
                    Não há consultas em que você não compareceu.
                    <br />
                    <Link
                      to={{
                        pathname: "/agendarconsultacliente",
